...
void writeResults(MultiBlockLattice2D<T,DESCRIPTOR>& lattice, MultiScalarField2D<T>& volumeFraction, plint iT)
{
...
int main(int argc, char **argv)
{
    ...
    catch(PlbIOException& except)
    {
        ...
        pcout << "6. delta_t .\n";
        pcout << "7. maxIter .\n";
        pcout << "Reasonable parameters on a desktop computer are: " << (std::string)global::argv(0) << " tmp 1.e-6 100 -1 80 1.e-4 80000\n\n";
        pcout << "Reasonable parameters on a parallel machine are: " << (std::string)global::argv(0) << " tmp 1.e-6 100 -1 250 1.e-4 80000\n";
        exit (EXIT_FAILURE);
    }
    ...
    FreeSurfaceFields2D<T,DESCRIPTOR> fields( blockStructure, dynamics->clone(), rhoEmpty,
    ...
    setToConstant(fields.flag, fields.flag.getBoundingBox(), (int)freeSurfaceFlag2D::wall);
