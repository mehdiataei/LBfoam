...
class BoxForcedVelocityFunctional2D : public BoxProcessingFunctional2D
{
public:
	virtual void processGenericBlocks(Box2D domain, std::vector<AtomicBlock2D*> blocks);
	virtual BoxForcedVelocityFunctional2D<T,Descriptor>* clone() const;
	virtual void getTypeOfModification(std::vector<modif::ModifT>& modified) const;
	virtual BlockDomain::DomainT appliesTo() const;
};

template<typename T, template<typename U> class Descriptor>  //mehdi
class BoxForcedVelocityComponentFunctional2D : public BoxProcessingFunctional2D
{
public:
	BoxForcedVelocityComponentFunctional2D(int iComponent_);
	virtual void processGenericBlocks(Box2D domain, std::vector<AtomicBlock2D*> blocks);
	virtual BoxForcedVelocityComponentFunctional2D<T,Descriptor>* clone() const;
	virtual void getTypeOfModification(std::vector<modif::ModifT>& modified) const;
	virtual BlockDomain::DomainT appliesTo() const;
private:
	int iComponent;
...
template<typename T, template<typename U> class Descriptor>
class BoxForcedVelocityNormFunctional2D : public BoxProcessingFunctional2D
{
public:
	virtual void processGenericBlocks(Box2D domain, std::vector<AtomicBlock2D*> blocks);
	virtual BoxForcedVelocityNormFunctional2D<T,Descriptor>* clone() const;
	virtual void getTypeOfModification(std::vector<modif::ModifT>& modified) const;
	virtual BlockDomain::DomainT appliesTo() const;
};
...
template<typename T, template<typename U> class Descriptor>
class LBMsmoothen2D : public BoxProcessingFunctional2D_SS<T,T>
{
public:
	virtual void process(Box2D domain, ScalarField2D<T>& data, ScalarField2D<T>& result);
	virtual LBMsmoothen2D<T,Descriptor>* clone() const;
	virtual void getTypeOfModification(std::vector<modif::ModifT>& modified) const;
};
