...
{
public:
    MaskedBoxRhoBarJfunctional3D(int flag_)
        : flag(flag_)
    { }
    virtual void processGenericBlocks(Box3D domain, std::vector<AtomicBlock3D*> fields);
...
template<typename T, template<typename U> class Descriptor>
class BoxKinematicEddyViscosityFunctional3D : public BoxProcessingFunctional3D_LS<T,Descriptor,T>
{
public:
    virtual void process(Box3D domain, BlockLattice3D<T,Descriptor>& lattice,
                         ScalarField3D<T>& scalarField);
...
template<typename T, template<typename U> class Descriptor>
class BoxNTensorKinematicEddyViscosityFunctional3D : public BoxProcessingFunctional3D_LN<T,Descriptor,T>
{
public:
    virtual void process(Box3D domain, BlockLattice3D<T,Descriptor>& lattice, NTensorField3D<T>& nu);
