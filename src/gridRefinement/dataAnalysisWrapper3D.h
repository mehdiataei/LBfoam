...
template<typename T, template<typename U> class Descriptor,
    template<typename T2, template<typename U2> class Descriptor2> class Engine>
std::unique_ptr<MultiLevelTensorField3D<T,Descriptor<T>::d> >
   computeVelocity(MultiLevelActions3D<T,Descriptor,Engine>& lattices, Box3D domain, plint levelOfDomain);

template<typename T, template<typename U> class Descriptor,
    template<typename T2, template<typename U2> class Descriptor2> class Engine>
std::unique_ptr<MultiLevelTensorFieldForOutput3D<T,Descriptor<T>::d> >
...
template<typename T, template<typename U> class Descriptor,
    template<typename T2, template<typename U2> class Descriptor2> class Engine>
std::unique_ptr<MultiLevelScalarField3D<T> >
   computeKinematicEddyViscosity(MultiLevelCoupling3D<T,Descriptor,Engine>& lattices, Box3D domain, plint levelOfDomain);
...
template<typename T, template<typename U> class Descriptor,
    template<typename T2, template<typename U2> class Descriptor2> class Engine>
std::unique_ptr<MultiLevelScalarFieldForOutput3D<T> >
   computeKinematicEddyViscosity(MultiLevelCoupling3D<T,Descriptor,Engine>& lattices, Box3D domain, plint levelOfDomain, bool crop);

/* *************** Strain Rate ****************************************** */

template<typename T, template<typename U> class Descriptor,
    template<typename T2, template<typename U2> class Descriptor2> class Engine>
void computeStrainRateFromStress(MultiLevelCoupling3D<T,Descriptor,Engine>& lattices, 
...
std::unique_ptr<MultiLevelTensorField3D<T,SymmetricTensor<T,Descriptor>::n> >
   computeStrainRateFromStress(MultiLevelCoupling3D<T,Descriptor,Engine>& lattices, Box3D domain, plint levelOfDomain);
...
std::unique_ptr<MultiLevelTensorFieldForOutput3D<T,SymmetricTensor<T,Descriptor>::n> >
   computeStrainRateFromStress(MultiLevelCoupling3D<T,Descriptor,Engine>& lattices, Box3D domain, plint levelOfDomain, bool crop);
...
template<typename T>
std::unique_ptr<MultiLevelTensorField3D<T,3> >
