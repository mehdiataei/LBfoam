...
class MultiGridScalarField3D : public ScalarFieldBase3D<T>, public MultiGrid3D {
    ...
    public:
        ...
        std::unique_ptr<MultiScalarField3D<T> > convertToLevel(plint level, plint dimDx=0, plint dimDt=0);
...
class MultiGridTensorField3D : public TensorFieldBase3D<T,nDim>, public MultiGrid3D {
    ...
    public:
        ...
        int getBlockId() const;
        std::unique_ptr<MultiTensorField3D<T,nDim> > convertToCoarsest(plint dimDx=0, plint dimDt=0);
        std::unique_ptr<MultiTensorField3D<T,nDim> > convertToFinest(plint dimDx=0, plint dimDt=0);
        std::unique_ptr<MultiTensorField3D<T,nDim> > convertToLevel(plint level, plint dimDx=0, plint dimDt=0);
    private:
