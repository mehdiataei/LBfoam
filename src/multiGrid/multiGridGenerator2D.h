...
class MultiGridGenerator2D {
    public:
        static std::unique_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeCubicInterpolationNoFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel );
                        
        static std::unique_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeLinearInterpolationNoFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel );
                        
        static std::unique_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeCubicInterpolationFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel );
                        
        static std::unique_ptr< MultiGridLattice2D<T,Descriptor> > createRefinedLatticeLinearInterpolationFiltering(
                        MultiGridManagement2D management,
                        Dynamics<T,Descriptor>* backgroundDynamics, plint behaviorLevel);
