...
public:
    DefaultInitializeFreeSurface3D(Dynamics<T,Descriptor>* dynamicsTemplate_, Dynamics<T,Descriptor>* emptyNodeDynamicsTemplate_,
        ...
        : dynamicsTemplate(dynamicsTemplate_), emptyNodeDynamicsTemplate(emptyNodeDynamicsTemplate_),
          force(force_), rhoIni(rhoIni_), useRhoIni(useRhoIni_),
...
public:
    N_MaskedInletConstVolumeFraction3D(T volumeFraction_)
        : volumeFraction(volumeFraction_)
    { }
    virtual void processGenericBlocks(Box3D domain, std::vector<AtomicBlock3D*> atomicBlocks);
...
public:
    N_MaskedOutletMaximumVolumeFraction3D(T volumeFraction_)
        : volumeFraction(volumeFraction_)
    { }
    virtual void processGenericBlocks(Box3D domain, std::vector<AtomicBlock3D*> atomicBlocks);
...
public:
    PunchSphere3D(Array<T,3> const& center_, T radius_, T rho0_, Dynamics<T,Descriptor>* emptyNodeDynamicsTemplate_)
        : center(center_),
          radius(radius_),
          rho0(rho0_),
...
public:
    AnalyticalPunchSphere3D(Array<T,3> const& center_, T radius_, T rho0_, Dynamics<T,Descriptor>* emptyNodeDynamicsTemplate_,
    ...
    AnalyticalPunchSphere3D(AnalyticalPunchSphere3D<T,Descriptor> const& rhs)
        : center(rhs.center),
          ...
          emptyNodeDynamicsTemplate(rhs.emptyNodeDynamicsTemplate->clone())
    { }
    AnalyticalPunchSphere3D<T,Descriptor>* operator=(AnalyticalPunchSphere3D<T,Descriptor> const& rhs)
    { 
