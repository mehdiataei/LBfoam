...
template< typename T,template<typename U> class Descriptor>
struct InterfaceLists3D : public ContainerBlockData {
	...
	virtual InterfaceLists3D<T,Descriptor>* clone() const
	{
		return new InterfaceLists3D<T,Descriptor>(*this);
	}
};
...
public:
	...
	FreeSurfaceProcessorParam3D(std::vector<AtomicBlock3D*>& atomicBlocks)
	{
		...
		interfaceLists_ = dynamic_cast<InterfaceLists3D<T,Descriptor>*>(containerInterfaceLists_->getData());
...
private:
	...
	InterfaceLists3D<T,Descriptor>* interfaceLists_;
