...
template<typename T>
std::unique_ptr<MultiScalarField3D<T> > computeNormalizedVolumeFraction(MultiScalarField3D<T>& volumeFraction, Box3D domain)
{
...
template<typename T>
std::unique_ptr<MultiScalarField3D<T> > computeNormalizedVolumeFraction(MultiScalarField3D<T>& volumeFraction)
{
