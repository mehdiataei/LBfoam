...
template<typename T>
class FavierDeltaFunction3D
{
public:
	FavierDeltaFunction3D(int N_)
		: N(N_),
		  dx(4./(T)N),
		  invDx(1./dx)
	{
...
template<typename T>
FavierDeltaFunction3D<T> const& favierDeltaFunction()
{
	static FavierDeltaFunction3D<T> deltaFunction(1000);
	return deltaFunction;
}

/* ******** inamuroDeltaFunction3D ************************************ */

template<typename T>
class inamuroDeltaFunction3D
{
public:
	inamuroDeltaFunction3D(int N_)
		: N(N_),
		  dx(4./(T)N),
		  invDx(1./dx)
	{
...
template<typename T>
inline inamuroDeltaFunction3D<T> const& inamuroDeltaFunction()
{
	static inamuroDeltaFunction3D<T> deltaFunction(1000);
	return deltaFunction;
}
